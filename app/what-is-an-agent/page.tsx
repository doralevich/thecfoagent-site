...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "A chatbot waits to be asked. An agent has a job, its own memory of your books, and permission to act. Here is the difference, in plain terms.",
...
const COMPARISON = [
  ...
  },
  {
    ...
    agent: "It keeps a working memory of your entities, your close, and how you report.",
  },
  {
    chatbot: "It can only tell you what to do.",
    agent: "It connects to your ERP, banking feeds, and reporting tools and does the step itself.",
  },
  {
    chatbot: "It is the same product for everyone.",
    agent: "It is configured around your chart of accounts, your cadence, and your board.",
  },
  {
      ...
      <main>
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              ...
              <p>
                ...
                close days instead of in prompts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                Finance runs on the most sensitive information in the company: margins,
        ...
        <ClosingCta
          ...
          body="Build your agent online in about fifteen minutes, or book a consultation and we will walk through exactly what it would do for your close."
        />
      </main>
      <Footer />
    </>
