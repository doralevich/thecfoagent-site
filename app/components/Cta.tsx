...
export function ClosingCta({
  heading = "Ready to Meet Your AI Finance Agent?",
  body = "Build your agent online in about fifteen minutes, or schedule a 30-minute consultation and we will show you exactly how it would be configured for your finance team.",
}: {
  heading?: string;
  body?: string;
}) {
