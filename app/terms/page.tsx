...
//
// The no-advice section is matched to THIS agent's domain and mirrors the boundary in the CFO Agent
// persona (config/personas.ts in apolloclaw2): an analysis and drafting tool that files and
// signs nothing, whose output is a starting point for the customer's own review.
//
...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "prose",
        text: "Nothing on this site is accounting, tax, audit, investment, or legal advice, and nothing here creates a professional or fiduciary relationship with you.",
      },
      {
        kind: "prose",
        text: "The agent itself is an analysis and drafting tool, not a licensed accountant, auditor, or financial adviser. It does not file anything, it does not sign anything, and its output is a starting point for your own review. For tax positions, statutory accounts, audit, and any binding or high-stakes financial decision, use a qualified professional.",
      },
    ],
  },
  {
