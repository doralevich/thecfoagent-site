...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "The CFO Agent is built by Apollo Claw, in-house on Long Island. Who builds it, why it exists, and how engagements are handled.",
  path: "/about",
  keywords: [
    "Apollo Claw",
    "David Oralevich",
        ...
        <section className="grid-light-section py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-ink leading-relaxed space-y-4">
              ...
              <p>
                What he saw was a gap. Finance teams were drowning in manual work while
                AI sat untapped. The technology existed to transform how CFOs and
                controllers operate. Nobody had built it for them.
              </p>
              <p>
                So he built it. Apollo Claw and a portfolio of industry-specific AI agents,
                each one purpose-built for a role. The CFO Agent is built on the same
                foundation.
              </p>
              <p>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                The CFO Agent is one of a family of role-specific agents from Apollo
