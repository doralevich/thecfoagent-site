...
export const metadata: Metadata = pageMeta({
  title: "Contact",
  description:
    "Talk to Apollo Claw about The CFO Agent. Book a 30-minute consultation, or reach us by email or phone from Roslyn Heights, New York.",
  path: "/contact",
  keywords: ["contact Apollo Claw", "CFO AI consultation", "book AI demo finance"],
});
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-cream rounded p-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed mb-4">
                  Thirty minutes. We will walk your close process and show you exactly
              ...
              <div className="bg-cream rounded p-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed mb-4">
                  Questions about ERP compatibility, scope, or pricing. We answer these
                  ourselves.
                </p>
                <a
